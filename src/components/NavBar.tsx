            ...
            <div className="flex gap-4 text-sm font-medium">
              {isExecutiveOrAdmin ? (
                <>
                  ...
                  <Link href="/dashboard/executive/agenda" className="text-gray-600 hover:text-blue-700 transition">Agenda</Link>
                  <Link href="/dashboard/executive/import" className="text-gray-600 hover:text-blue-700 transition">Import</Link>
                  {profile?.role === 'admin' && (
